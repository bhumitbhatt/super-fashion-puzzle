...
- (void)dealloc {
	...
	[[FacebookManager sharedFacebookManager] release];
	[[SoundManager sharedSoundManager] release];
	[window release];
	[super dealloc];
}
