...
@implementation LocalHighscoresView
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self != nil) {
		...
		// create name label
		CGRect rectName=CGRectMake(RANK_WIDTH_PERCENTAGE*width, 0, (NAME_WIDTH_PERCENTAGE+COUNTRY_WIDTH_PERCENTAGE)*width, height);
